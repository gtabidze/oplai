...
export function AppSidebar() {
  ...
  return (
    <Sidebar collapsible="icon">
      ...
      >
        {open ? (
          <svg width="80" height="32" viewBox="0 0 460 181" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-foreground">
          ...
          <svg width="20" height="32" viewBox="0 0 128 181" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-foreground">
